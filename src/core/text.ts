...
export function link(options: LinkOptions, ...children: readonly RichTextInput[]) {
  return textEntity<RichTextUrl>({ type: "url", url: options.url }, "link()", children);
}
export interface EmailOptions { address: string; }
export function email(options: EmailOptions, ...children: readonly RichTextInput[]) {
  return textEntity<RichTextEmailAddress>({ type: "email_address", email_address: options.address }, "email()", children);
}
export interface PhoneOptions { number: string; }
export function phone(options: PhoneOptions, ...children: readonly RichTextInput[]) {
  return textEntity<RichTextPhoneNumber>({ type: "phone_number", phone_number: options.number }, "phone()", children);
}
...
export function bankCard(options: BankCardOptions, ...children: readonly RichTextInput[]) {
  return textEntity<RichTextBankCardNumber>({ type: "bank_card_number", bank_card_number: options.number }, "bankCard()", children);
}
...
export function mention(options: MentionOptions, ...children: readonly RichTextInput[]) {
  return textEntity<RichTextMention>({ type: "mention", username: options.username }, "mention()", children);
}
...
export function hashtag(options: HashtagOptions, ...children: readonly RichTextInput[]) {
  return textEntity<RichTextHashtag>({ type: "hashtag", hashtag: options.value }, "hashtag()", children);
}
...
export function cashtag(options: CashtagOptions, ...children: readonly RichTextInput[]) {
  return textEntity<RichTextCashtag>({ type: "cashtag", cashtag: options.value }, "cashtag()", children);
}
...
export function botCommand(options: BotCommandOptions, ...children: readonly RichTextInput[]) {
  return textEntity<RichTextBotCommand>({ type: "bot_command", bot_command: options.command }, "botCommand()", children);
}
...
export function anchorLink(options: NamedTextOptions, ...children: readonly RichTextInput[]) {
  return textEntity<RichTextAnchorLink>({ type: "anchor_link", anchor_name: options.name }, "anchorLink()", children);
}
export function reference(options: NamedTextOptions, ...children: readonly RichTextInput[]) {
  return textEntity<RichTextReference>({ type: "reference", name: options.name }, "reference()", children);
}
export function referenceLink(options: NamedTextOptions, ...children: readonly RichTextInput[]) {
  return textEntity<RichTextReferenceLink>({ type: "reference_link", reference_name: options.name }, "referenceLink()", children);
}
